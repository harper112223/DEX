    ...
    return Scaffold(
      ...
      body: BlocConsumer<OtpCubit, OtpState>(
        buildWhen: (previous, current) {
          if (current is VerifyOTPSucssState) {
            return false;
          } else {
            return true;
          }
        ...
        listener: (context, state) {
          if (state is VerifyOTPSucssState) {
            ...
            state.errorMessage.showSnackBar(context);
          } else if (state is ResendOtpSendSucssState) {
            setState(() {
              _otpCode = '';
              _start = 15;
              startTimer();
